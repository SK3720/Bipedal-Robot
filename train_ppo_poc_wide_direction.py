"""PPO recovery training with uniform (wide) push directions."""
...
def make_env():
    ...
    env.push_direction_mode = PUSH_DIRECTION_WIDE
...
def main():
    ...
    print(
        f"Training wide-direction recovery PPO for {TOTAL_TIMESTEPS} steps "
        f"(push {POC_PUSH_FORCE_MIN}-{POC_PUSH_FORCE_MAX} N, "
        f"direction ~ Uniform(0, 2pi), "
